...
export const ru: Translations = {
  ...
  controlPanel: {
    ...
    vsyncTooltip: 'Синхронизирует вывод кадров с частотой обновления монитора, устраняя разрывы изображения (включено по умолчанию). scrcpy 4.0 (SDL3) отключает это по умолчанию. Выключите для немного меньшей задержки ввода.',
    rendererAuto: 'Авто',
